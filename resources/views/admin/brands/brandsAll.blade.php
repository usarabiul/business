    ...
    <div class="col-md-6">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Brands List</li>
            </ol>
        </div>
    </div>
    <div class="col-md-6">
        <div class="text-start text-md-end mb-3">
            <a href="{{route('admin.brandsAction','create')}}" class="btn btn-info"><i class="fa-solid fa-plus"></i> Add Client</a>
            <a href="{{route('admin.brands')}}" class="btn btn-success">
